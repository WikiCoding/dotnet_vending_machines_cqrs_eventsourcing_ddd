...
public class ProductAddedTopicConsumer : BackgroundService
{
    private readonly IConsumer<Ignore, string> _consumer;
    private readonly IConfiguration _configuration;
    private readonly IServiceProvider _serviceProvider;

    public ProductAddedTopicConsumer(IConfiguration configuration, IServiceProvider serviceProvider)
    {
    ...
    {
        const string topic = "product-added-topic";
